class XML
  ...
  def tag(tagname, attributes={})
    ...
    # This block has content
      ...
      content = yield # Invoke the block to output or return content if content 
      # If any content returned
      @out << content.to_s # Output it as a string end
  ...
  # Second: run a block in a new instance of the class. i
